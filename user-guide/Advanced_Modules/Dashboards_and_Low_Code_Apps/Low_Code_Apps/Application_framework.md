...
> [!TIP]
> If you need some guidelines on how to create a visually appealing and user-friendly low-code app, check the [Best practices page](xref:Low_code_apps_best_practices)
